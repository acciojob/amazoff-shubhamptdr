...
public class OrderController {
    ...
    public ResponseEntity<String> deletePartnerById(@PathVariable String partnerId){
        ...
        return new ResponseEntity<>(orderService.deletePartnerById(partnerId) + " removed successfully", HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<String> deleteOrderById(@PathVariable String orderId){
        ...
        return new ResponseEntity<>(orderService.deleteOrderById(orderId) + " removed successfully", HttpStatus.CREATED);
    }
}
